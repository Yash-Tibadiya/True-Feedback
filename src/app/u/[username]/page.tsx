...
export default function SendMessage() {
  ...
  return (
    // <div className="relative flex flex-col min-h-screen transition-colors duration-300 bg-white dark:bg-black dark:bg-gradient-to-tr bg-gradient-to-tr from-white to-blue-950 dark:from-black dark:to-blue-900 overflow-hidden">
    //   <div className="flex flex-col items-start justify-start w-full p-4 sm:p-8 md:p-12 lg:p-16 z-10">
    //     <div className="w-full max-w-4xl mx-auto backdrop-blur-sm bg-white/20 dark:bg-gray-700/40 rounded-2xl shadow-lg p-6">
    ...
    //                     className="resize-none w-full py-3 px-4 rounded-lg bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-200 focus:ring-2 focus:ring-blue-500 shadow-inner"
    //                     {...field}
    //                   />
    //                 </FormControl>
    ...
    //           </p>
    //         </div>
    //         <Card className="border border-gray-300/50 dark:border-gray-700/50 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm shadow-sm">
    ...
    //                   key={index}
    //                   variant="outline"
    //                   className="border border-gray-300/50 dark:border-gray-700/50 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm text-gray-700 dark:text-gray-300 hover:bg-white/80 dark:hover:bg-gray-700/80 transition-all duration-200 shadow-sm text-left justify-start px-4 py-3"
    ...
    //   {/* Footer */}
    //   {/* <div className="text-center py-4 sticky bottom-0 z-50 bg-white/10 dark:bg-blue-950/70 backdrop-blur-sm mt-auto">

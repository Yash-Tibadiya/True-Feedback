...
export default function Dashboard() {
  ...
  return (
    ...
    //                 value={profileUrl}
    //                 readOnly
    //                 className="w-full py-2.5 px-4 pr-10 rounded-lg bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-200 focus:ring-2 focus:ring-blue-500"
    //               />
    //             </div>
    //             <Button
    ...
    //         {/* Messages Section */}
    //         <div className="p-6 backdrop-blur-sm bg-white/20 dark:bg-gray-700/40 rounded-2xl shadow-lg">
    ...
    //               className="border border-gray-300/50 dark:border-gray-700/50 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm text-gray-700 dark:text-gray-300 hover:bg-white/80 dark:hover:bg-gray-700/80 transition-all duration-200 shadow-sm"
    //               disabled={isLoading}
    //             >
    //               {isLoading ? (
    ...
    //   </div>
    //   {/* Footer */}
    //   {/* <div className="text-center py-4 sticky bottom-0 z-50 dark:bg-blue-950/70">
